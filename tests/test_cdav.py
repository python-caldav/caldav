...
class TestErrorUnitTestBot:
    # This test have been generated by UnitTestBot (utbot.org)
...
class TestRegressionUnitTestBot:
    ...
    def test_to_utc_date_string(self):
        """
        ts = datetime.datetime(1, 1, 1, fold=1)
        """
        actual = _to_utc_date_string(datetime.datetime(1, 1, 1, fold=1))

        assert actual == '00010101T000000Z'
