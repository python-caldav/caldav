...
def _detect_component_type_from_string(data: str) -> Optional[str]:
    """
...
def _detect_component_type_from_icalendar(ical_obj: Any) -> Optional[str]:
    """
...
def _detect_component_type(data: Any) -> Optional[str]:
    """
...
def _generate_fake_sync_token(etags_and_urls: List[Tuple[Optional[str], str]]) -> str:
    """
...
def _is_fake_sync_token(token: Optional[str]) -> bool:
    """
