...
nextcloud = {
    ...
    ## a spent UUID is only available after things have been cleared out from
    ## the trashbin - hence `delete-calendar.free-namespace` should be set to
    ## unsupported.  However, the docker test container in this project
    ## comes with the trashbin disabled.  The grade here is "fragile" - as in
    ## "varies by deployment".  There is never any fragility
