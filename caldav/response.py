...
def _collect_prop_elements(propstats: "list[_Element]") -> "dict[str, _Element]":
    ...
    Propstats whose status reports 404 are skipped — that is the single,
    ...
    :meth:`DAVResponse._find_objects_and_props` collect prop children, so the
    quirk no longer has to be maintained in two parallel loops (code-review
    §5.7).
    """
